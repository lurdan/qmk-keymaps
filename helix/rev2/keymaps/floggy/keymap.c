...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_OPT] = LAYOUT( \
      ...
      JP_DOT,  KC_V,   KC_C,    KC_L,   KC_Z,      KC_Q,                      _______,  _______,  _______,  _______,  _______,  _______, \
  ...
  [_NUM] = LAYOUT( \
      ...
      KC_NLCK,  KC_P0,   KC_P1,      KC_P2,   KC_P3,   LGUI(KC_S),     _______, _______, _______,  _______,  _______,  _______,  _______,  _______, \
